    ...
    <b-container fluid class="footer">
                ...
                <b-row>
                    ...
                    <b-col lg="4">
                        <b-list-group flush>
                            ...
                            <b-list-group-item href="https://top1st.github.io/watch-token/" target="_blank" class="text-light">
                                Create ERC20 Widget
                            </b-list-group-item>
                            <b-list-group-item href="https://top1st.github.io/bep20-generator/" target="_blank" class="text-warning">
                                Create BEP20 Token
                            </b-list-group-item>
                        </b-list-group>
                    </b-col>
        ...
        <b-modal id="modal-terms"
            ...
            <b-embed
                    type="iframe"
                    aspect="4by3"
                    src="https://top1st.github.io/erc20-generator-terms/"
                    allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture"
                    allowfullscreen
            ></b-embed>
        </b-modal>
